...
int main() {
  ...
  find_phonetic_ending("SEE", phonetics);
  cout << "SEE has phonetic ending " << phonetics << endl;

  find_phonetic_ending("THEE", phonetics);
  cout << "THEE has phonetic ending " << phonetics << endl;
